...
public interface IMemberDB {
    ...
    /**
     * Returns a CHC5223.Member object mapped to the supplied name.
     * @pre name not null and not empty string
     * @param name The CHC5223.Member name (key) to locate
     * @return the CHC5223.Member object mapped to the key name if the name
...
public boolean isEmpty();
    ...
    /**
     * Inserts a CHC5223.Member object into the database, with the key of the supplied
     * member's name.
